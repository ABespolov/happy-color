...
/// A thumbnail that is still decoding eases in once it arrives, growing
/// slightly as it fades; one the image cache already has is drawn as it is,
/// so a grid that was seen before comes back without a flicker.
Widget _fadeIn(
...
class _AppearState extends State<_Appear> with SingleTickerProviderStateMixin {
  ...
  late final _scale = Tween<double>(begin: 0.97, end: 1).animate(

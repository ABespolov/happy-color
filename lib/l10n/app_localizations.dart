...
abstract class AppLocalizations {
  ...
  /// No description provided for @myFeedTab.
  ///
  /// In en, this message translates to:
  /// **'My Feed'**
  String get myFeedTab;
  ...
  /// No description provided for @starredSection.
  ///
  /// In en, this message translates to:
  /// **'Starred'**
  String get starredSection;
  ...
  /// No description provided for @starredEmptyAction.
  ///
  /// In en, this message translates to:
  /// **'Try'**
  String get starredEmptyAction;

  /// No description provided for @completedEmpty.
  ///
  /// In en, this message translates to:
  /// **'All your completed pictures are saved here'**
  String get completedEmpty;

  /// No description provided for @completedEmptyAction.
  ///
  /// In en, this message translates to:
  /// **'Start coloring'**
